...
LEXERS = {
    ...
    'CSSUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'CSS+UL4', ('styles+ul4',), ('*.cssul4',), ()),
    ...
    'CssDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'CSS+Django/Jinja', ('styles+django', 'styles+jinja'), ('*.styles.j2', '*.styles.jinja2'), ('text/styles+django', 'text/styles+jinja')),
